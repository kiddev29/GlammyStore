    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/js/core").Include(
                ...
                "~/Assets/Client/js/jqueryui.custom.min.js",
                "~/Assets/Client/js/parallax.js",
                "~/Assets/Client/js/jquery.sticky.js",
                "~/Assets/Client/js/jquery.flexslider-min.js",
                "~/Assets/Client/js/jquery.jcarousel.js",
                "~/Assets/Client/js/fancySelect.js",
                "~/Assets/Client/js/animate.js",
            ...
            bundles.Add(new StyleBundle("~/css/core")
                ...
                .Include("~/Assets/Client/css/fancySelect.css", new CssRewriteUrlTransform())
