...
namespace GlammyStore.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(GlammyStoreDbContext.Create);
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<GlammyStoreDbContext>());
